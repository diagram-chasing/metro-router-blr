...
landcoverKeys   = { fell="grass", grassland="grass", grass="grass", heath="grass", meadow="grass", allotments="grass", park="grass", village_green="grass", recreation_ground="grass", scrub="grass", shrubbery="grass", tundra="grass", garden="grass", golf_course="grass", park="grass" }
...
function relation_scan_function()
    if Find("type")=="boundary" and Find("boundary")=="local_authority" and Find("admin_level")=="8" then
        Accept()
    end
end
...
function way_function()
    ...
    -- Boundaries in ways
    if boundary=="local_authority" then
        isBoundary = true
    end
...
function attribute_function(attr,layer)
    if attr["featurecla"]=="Urban area" then
